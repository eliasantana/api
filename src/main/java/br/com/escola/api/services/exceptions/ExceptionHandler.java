...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(AlunoException.class)
    public ResponseEntity<StandardError>alunoException(AlunoException ex, HttpServletRequest request){
